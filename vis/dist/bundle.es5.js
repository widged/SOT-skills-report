...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {/* jshint esnext: true */
	...
	function main() {
	  ...
	  _imports.Inject.css({ file: '../dist/css/skill-vis.css', parent: module });
	  _imports.Inject.css({ file: '../dist/css/sot-branding.css', parent: module });
	  _imports.Inject.css({ file: '../dist/css/student-chart.css', parent: module });
	  _imports.Inject.css({ file: '../dist/css/skill-bubbles.css', parent: module });

	  _imports.Inject.js(['../dist/data/secondary.jsonp', '../dist/data/skills.jsonp', '../dist/data/skills_bubbles.jsonp', '../section-secondary/script.js', './../vendor/d3/d3.v3.min.js', './../dist/data/sot.jsonp'], function () {
	    ...
	    _react2['default'].render(_react2['default'].createElement(_sectionSkillsSkillVisEs6Js2['default'], { primarySkills: jsonp_skills, secondarySkills: jsonp_secondary, handlePrimaryChange: handlePrimaryChange }), document.getElementById('skills-vis'));

	    var students = _react2['default'].render(_react2['default'].createElement(_sectionStudentsStudentChartEs6Js2['default'], { list: items }), document.getElementById('students-vis'));
