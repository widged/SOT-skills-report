...
/***/ function(module, exports, __webpack_require__) {
	...
	function drawChart(csv) {
	    ...
	    var StudentChart = __webpack_require__(161);
	    ...
	    var ItemTooltip = __webpack_require__(164);
	    var ColorLegend = __webpack_require__(165);
	    ...
	    var BubbleChart = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StudentChart = (function () {
	    ...
	    _createClass(StudentChart, null, [{
	        key: 'getAchievementColor',
	        value: function getAchievementColor(value) {
	            var color = '#FF00CC';
	            if (value <= -2) {
	                color = '#ff0000';
	            } else if (value <= -1) {
	        ...
	        key: 'getGradeColor',
	        value: function getGradeColor(value) {
	            var colors = {
	                '*': '#FF00CC',
	                'Z': '#FF00CC',
	                'A': '#00FF00',
	        ...
	        value: function addControls(_ref2) {
	            ...
	            var SelectBy = __webpack_require__(162);
	            var FilterList = __webpack_require__(163);
...
/***/ function(module, exports) {
	...
	var BubbleChart = (function () {
	  ...
	  _createClass(BubbleChart, [{
	    ...
	    key: "use_filters",
	    value: function use_filters(filters) {
